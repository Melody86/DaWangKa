...
<template>
  <div class="unicom-index">
    <div class="dawang-banner">
      <img src="../../assets/images/20240312/WechatIMG3253.jpg" style="width: 100%" />
    </div>
...
export default {
  ...
  data() {
    return {
      BannerStyle: {
        backgroundImage: 'url(' + require('@/assets/images/20240312/WechatIMG3253.jpg') + ')',
