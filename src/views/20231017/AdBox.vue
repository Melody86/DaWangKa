<template>
  <div style="">
    <div style="position: relative" v-show="showMM">
      <img src="../../assets/images/20231017/light_190805.png" alt="" style="width: 100%; opacity: 0" />
...
export default {
  ...
  data() {
    return {
      ...
      parser: new Parser(),
      player: null,
      svgimg: require('../../assets/images/20231017/nactive.svga')
    }
  },
  mounted() {
...
.mm-bg {
  background-image: url(../../assets/images/20231017/light_190805.png);
