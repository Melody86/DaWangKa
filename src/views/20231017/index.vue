...
<template>
  <div class="unicom-index">
    <div class="dawang-banner">
      <img src="../../assets/images/20231017/fcihr3l3k6.webp" style="width: 100%" />
    </div>
...
export default {
  ...
  data() {
    return {
      BannerStyle: {
        backgroundImage: 'url(' + require('@/assets/images/20231017/fcihr3l3k6.webp') + ')',
