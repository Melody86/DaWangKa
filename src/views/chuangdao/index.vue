...
<template>
  <div class="unicom-index">
      ...
      >
        <div class="neiDiv">
          ...
          <div class="guiDiv guiDiv1" style="margin-top: 0.2rem; background-color: #e5e5e5">
            ...
            <img
              @click="showAreaList = true"
              src="@/assets/images/chuangdao/weapp-wk02/images/red19/bannel3.png"
              class="upDiv"
          ...
          <div class="haoDiv">
            <div class="xDiv" v-for="(item, index) in list" v-bind:key="index" v-if="index < 8">
              ...
              >
                <img
                  src="@/assets/images/chuangdao/weapp-wk02/images/bannel5.gif"
                ...
                >
                <img
                  src="@/assets/images/chuangdao/weapp-wk02/images/bannel6.png"
    ...
    <div v-if="showTopAD" @click="showTopAD = false" class="tanDiv">
      <img
        class="tanImg"
        :src="require('@/assets/images/chuangdao/topimg.png')"
        style="
          position: absolute;
          width: 78%;
          left: 50%;
    ...
    return {
      banner:
        parseInt(process.env.VUE_APP_SHENHE) === 0
          ? require('@/assets/images/chuangdao/2.gif')
          : require('@/assets/images/chuangdao/shenhe/banner.png'),
      form1:
        parseInt(process.env.VUE_APP_SHENHE) === 0
          ? require('@/assets/images/chuangdao/weapp-wk02/images/red19/WechatIMG526.jpeg')
          : require('@/assets/images/chuangdao/shenhe/weapp-wk02/images/red19/bannel8.png'),
      form2:
        parseInt(process.env.VUE_APP_SHENHE) === 0
          ? require('@/assets/images/chuangdao/weapp-wk02/images/red19/bannel9.png')
          : require('@/assets/images/chuangdao/shenhe/weapp-wk02/images/red19/bannel9.png'),
      form3:
        parseInt(process.env.VUE_APP_SHENHE) === 0
          ? require('@/assets/images/chuangdao/weapp-wk02/images/red19/bannel10.png')
          : require('@/assets/images/chuangdao/shenhe/weapp-wk02/images/red19/bannel10.png'),
      form4:
        parseInt(process.env.VUE_APP_SHENHE) === 0
          ? require('@/assets/images/chuangdao/weapp-wk02/images/red19/bannel10.png')
          : require('@/assets/images/chuangdao/shenhe/weapp-wk02/images/red19/bannel10.png'),
      ...
      fixedButton:
        parseInt(process.env.VUE_APP_SHENHE) === 0
          ? require('@/assets/images/chuangdao/weapp-hndxxk/assets/index/banner14.png')
          : require('@/assets/images/chuangdao/shenhe/weapp-hndxxk/assets/index/banner14.png'),
      ...
      pneiDList: [
        {
          img: require('@/assets/images/chuangdao/weapp-wk02/images/top1.jpg'),
          name: '钱****多',
          desc: '已经激活了，从下单到现在...'
        },
        {
          img: require('@/assets/images/chuangdao/weapp-wk02/images/top2.jpg'),
          name: 'w***g',
          desc: '对于宿舍没WiFi的孩子，这是雪中...'
        },
        {
          img: require('@/assets/images/chuangdao/weapp-wk02/images/top3.jpg'),
          name: 'C****n',
          desc: '最近知乎也免流啦～哈哈哈哈哈...'
        },
        {
          img: require('@/assets/images/chuangdao/weapp-wk02/images/top4.jpg'),
          name: '粉***生',
          desc: '双卡双4g,当副卡来用最划算...'
        },
        {
          img: require('@/assets/images/chuangdao/weapp-wk02/images/top5.jpg'),
          name: 'w***g',
          desc: '用了三年了，不用担心没有WiFi...'
        },
        {
          img: require('@/assets/images/chuangdao/weapp-wk02/images/top6.jpg'),
          name: '见**',
          desc: '免流随便下，真的爽...'
        },
        {
          img: require('@/assets/images/chuangdao/weapp-wk02/images/top7.jpg'),
          name: 'D***d',
          desc: '免去腾讯系的应用流量其实很好..'
        }
      ],
