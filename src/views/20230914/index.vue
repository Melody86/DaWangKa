...
<template>
  <div class="unicom-index">
    <div class="dawang-banner">
      <img src="../../assets/images/20230914/1.webp" style="width: 100%" />
      <img src="../../assets/images/20230914/2.webp" style="width: 100%" />
    </div>
...
export default {
  ...
  data() {
    return {
      BannerStyle: {
        backgroundImage: 'url(' + require('@/assets/images/20230914/1.webp') + ')',
