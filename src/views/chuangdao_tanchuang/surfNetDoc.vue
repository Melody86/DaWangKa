      ...
      <div class="agreementContent">
        ...
        <div class="agreementDetail">
          ...
          <div>
            ...
            <p>
              10、乙方非常重视用户的隐私和个人信息保护，并会尽全力保护用户的个人信息安全可靠。关于乙方如何收集、存储、使用、披露和保护您的个人信息，请见乙方不时更新、修订并公布的《中国联通用户隐私政策》，网址为www.10010.com。
            </p>
          </div>
          <div>
            ...
            <p>
              （六）若非双方另行约定，乙方提供的宽带接入线路最多限定X个终端上网使用，未经乙方书面同意，甲方不得私自组网连接其他终端设备。
            </p>
            ...
            <p>
              （十六）为了更好地为甲方提供与本套餐相关的服务，甲方同意由乙方将甲方的电话号码等信息提供给乙方合作的第三方。
            </p>
            <p>（十七）携号转网相关约定：</p>
            <p>
          ...
          <div>
            ...
            <p>
              在本协议签约页面点击确认签署本协议前，请确保您已充分阅读并完全同意本协议内容，一旦您点击确认签署本协议，即表明您已充分阅读并完全同意本协议内容，本协议即在您与乙方（中国联合网络通信有限公司____________分公司）之间产生法律效力。如果您不同意本协议的任意内容，或者无法准确理解乙方（中国联合网络通信有限公司____________分公司）对条款的解释，请不要进行后续操作。本协议一式两份，甲乙双方各执一份，有效期一年。协议到期后，双方如无异议，有效期以一年为周期自动顺延。
            </p>
          </div>
        </div>
        <div class="agreementTop">
        ...
        <div class="agreementDetail">
          ...
          <p>
            本协议作为《中国联通客户入网服务协议》的补充协议，甲乙双方在平等自愿、公平诚信的基础上，基于对乙方腾讯王卡移网通信服务的了解和需求，达成协议如下：
          </p>
          <p>
            第一条
            甲方所选择的腾讯王卡移网业务套餐及相关资费、移网业务优惠活动及协议期限等内容详见腾讯王卡电子业务受理单和腾讯王卡的“王卡助手”官方微信公众号。
          </p>
          <p>
            第二条
            若乙方出于提升用户感知及体验需求，不定期推出相关通信业务优惠产品体验资格，甲方同意接受乙方通过短信、微信、电话等渠道进行服务通知和通信业务营销。
          </p>
          <p>
            第三条
          ...
          <p>（四）甲方须按时缴清当月的通信费。</p>
          <p>
            （五）甲方需按照乙方提供的使用说明对专属号卡进行激活、绑定和使用，如未按使用说明操作造成甲方无法享受特定条件下专属流量活动，责任由甲方承担。
          </p>
          <p>
            （六）甲方参加乙方与第三方合作活动（如2020年春节营销活动等），按活动相关规则参与充值话费享X个月福利活动，则视为甲方已同意承诺：参与乙方活动的腾讯王卡，激活后（套餐首次生效日）承诺在网并使用腾讯王卡连续X个自然月。若在本协议期未满前，甲方参与活动的号码因销户、转非腾讯王卡套餐、转腾讯王卡亲情卡套餐、携号转网等情形需立即终止本协议履行，甲方需解除合约，合约解除次月不享有活动福利相关的权益资格。
          </p>
          <p>
            （七）甲方参加乙方的特定条件下专属流量活动时，需保证通信服务处于正常使用的状态。如因逾期欠费停机等原因造成甲方通讯服务中断期间，无法参与特定条件下专属流量活动；甲方如申请办理停机保号业务，乙方停止专属流量活动，收取停机保号费，不再收取套餐月费。甲方当月办理恢复开机业务后，乙方当月恢复提供的特定条件下专属流量活动；如甲方在次月或次月之后办理恢复开机业务，仅从甲方办理恢复开机业务所在月起开始恢复特定条件下专属流量活动权益。
            甲方停机保号期间的专属流量活动不再追补。
          </p>
          <p>
            （八）甲方若没有使用靓号，在有套餐变更为非腾讯王卡卡内套餐（含携号转网）的需求时，则视为甲方放弃本协议中约定的套餐的专属优惠权益。甲方如使用靓号，在靓号协议期内不允许办理停机保号、不降低月承诺通信费。若靓号月承诺通信费与套餐有差异，以“就高”原则处理。如甲方办理靓号过户，新客户需重新签订靓号入网协议。
          </p>
        ...
        <div class="agreementDetail">
          ...
          <p>
            （甲方承诺：本人已经充分、完整阅读并理解本协议所述全部条款及条件。如申请或使用乙方提供的业务，即视为您已阅读并同意受本协议的约束。）
          </p>
          <p>甲方： ____________</p>
